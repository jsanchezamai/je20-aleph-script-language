...
export class CosteUniforme extends Control {
    ...
    busquedaNoInformada(): GrafoS[] {
        ...
        console.log("Búsqueda no informada. CosteUniforme");
        ...
        while (this.abierta.length > 0) {
            ...
            const S = n.arcos.sort((a, b) => a.coste < b.coste ? -1 : 1);
            S.forEach(q => {
                console.log("\t - Sucesor q: ", q.nodo.Id(), "Coste: ", q.coste);
                const ta = {
                    anterior: n,
